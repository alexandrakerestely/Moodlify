...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DeleteUser = channel.unary_unary(
                '/com.POSproject.grpc.AuthService/DeleteUser',
        ...
        self.UpdateUser = channel.unary_unary(
                '/com.POSproject.grpc.AuthService/UpdateUser',
                request_serializer=idm__pb2.UpdateRequest.SerializeToString,
                response_deserializer=idm__pb2.UpdateResponse.FromString,
                _registered_method=True)
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateUser': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateUser,
                    request_deserializer=idm__pb2.UpdateRequest.FromString,
                    response_serializer=idm__pb2.UpdateResponse.SerializeToString,
            ),
    }
...
class AuthService(object):
    ...
    def UpdateUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/com.POSproject.grpc.AuthService/UpdateUser',
            idm__pb2.UpdateRequest.SerializeToString,
            idm__pb2.UpdateResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
